...
/*
 * File Name: EventListActivity.java
...
public class EventListActivity extends Activity {
    ...
    // populate the spinner with existing event types
    ...
    // update the event list based on search criteria
    ...
    // String helper to convert to titlecase
